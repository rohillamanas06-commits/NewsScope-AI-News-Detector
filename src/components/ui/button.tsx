  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium font-body transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero:
          "bg-gradient-to-r from-gold to-gold-light text-primary font-semibold shadow-lg hover:shadow-xl hover:scale-[1.03] active:scale-[0.98]",
        heroOutline:
          "border-2 border-gold/50 bg-transparent text-gold hover:bg-gold/10 hover:border-gold backdrop-blur-sm",
        glass:
          "bg-background/10 backdrop-blur-md border border-border/50 text-foreground hover:bg-background/20 hover:border-border",
      },
      size: {
